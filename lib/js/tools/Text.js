                ...
                (function(_this) {
                    return function(arg) {
                        ...
                        if (getIsPointInBox(point, br)) {
                            ...
                            getIsPointInBox(point, selectionShape.getBottomRightHandleRect())
                        ) {
                            return lc.setCursor('nwse-resize');
                        } else if (getIsPointInBox(point, selectionShape.getTopLeftHandleRect())) {
                            return lc.setCursor('nwse-resize');
                        } else if (
                            getIsPointInBox(point, selectionShape.getBottomLeftHandleRect())
                        ) {
    ...
    Text.prototype._updateInputEl = function(lc, withMargin) {
        ...
        if (withMargin) {
            this.inputEl.style.height =
                br.height + 8 + this.currentShape.renderer.metrics.leading + 'px';
        } else {
