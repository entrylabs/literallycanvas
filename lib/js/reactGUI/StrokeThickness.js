...
var StrokeThickness = createReactClass({
    ...
    onValidValue: function onValidValue(size) {
    ...
    onChange: function onChange(strokeWidth) {
    ...
    render: function render() {
        ...
        var _props = this.props,
            lc = _props.lc,
            name = _props.name;
        var _state$strokeWidth = this.state.strokeWidth,
            strokeWidth = _state$strokeWidth === undefined ? 5 : _state$strokeWidth;
