    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            isStroke && React.createElement(
                'div',
                { className: 'strokeColor', ref: function ref(dom) {
                        return _this2.strokeColor = dom;
                    } },
                React.createElement(
                    'div',
                    { className: 'title' },
            ...
            isFill && React.createElement(
                'div',
                { className: 'fillColor', ref: function ref(dom) {
                        return _this2.fillColor = dom;
                    } },
                React.createElement(
                    'div',
                    { className: 'title' },
