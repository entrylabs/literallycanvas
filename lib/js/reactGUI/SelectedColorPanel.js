...
var _require = require('EntryTool'),
    ...
    colorPicked: function colorPicked(colorCode) {
        ...
        if (!this.isRunRAF) {
            ...
            requestAnimationFrame(function() {
                ...
                if (_this2.state.selected === 'primary')
                    _this2.setState({ strokeColor: colorCode });
                else _this2.setState({ fillColor: colorCode });
                _this2.props.lc.setColor(_this2.state.selected, colorCode);
                if (_this2.props.colorPrefix)
                    _this2.props.lc.setColor(
                        _this2.props.colorPrefix + '-' + _this2.state.selected,
                        colorCode
                    );
            });
        }
