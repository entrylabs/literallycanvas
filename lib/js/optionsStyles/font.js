var ALL_FONTS, FONT_NAME_TO_VALUE, MONOSPACE_FONTS, OTHER_FONTS, React, ReactDOM, SANS_SERIF_FONTS, SERIF_FONTS, _, createReactClass, defineOptionsStyle, i, j, l, len, len1, len2, len3, m, name, ref, ref1, ref2, ref3, value;
...
defineOptionsStyle('font', createReactClass({
  ...
  render: function() {
    ...
    lc = this.props.lc;
    div = ReactDOM.div, input = ReactDOM.input, select = ReactDOM.select, option = ReactDOM.option, br = ReactDOM.br, label = ReactDOM.label, span = ReactDOM.span, optgroup = ReactDOM.optgroup;
    return div({
