...
var Palette = React.createClass({
    ...
    getInitialState: function() {
        ...
        if (this.props.disableTransparent) {
            for (var i = 0; i < 7; i++) colourCodes[i * 10] = colourCodes[i * 10 + 10];
    ...
    render: function() {
        ...
        return (
            <div className="entryPlaygroundPainterAttrColorContainer">
        ...
        return (
            <div className="entrySelectedColorPanel">
                ...
                {/* <Palette
                    ...
                    disableTransparent={this.props.disableTransparent}
                />
                <ColorSpoid
                    imageURLPrefix={this.props.imageURLPrefix}
                    lc={this.props.lc}
